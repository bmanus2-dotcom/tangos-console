...
// Source lines for the viewer's code-level zoom. srcPath (repo-relative) is read with a
// path-traversal guard; unmatched functions fall back to a disasm text field on the
// chaos-db row when the generator provides one. Best-effort: null instead of throwing.
